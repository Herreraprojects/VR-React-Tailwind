    ...
    <div className='w-full py-16 text-white px-4'>
        <div className='mx-w-[1240px] mx-auto grid lg:grid-cols-3'>
            <div className='lg:col-span-2 my-4'>
                <h1 className='md:text-4xl sm:text-2xl text-2xl font-bold py-2'>Want to learn more about VR?</h1>
                <p>Sign up to our newslettter and stay up to date.</p>
            </div>
            <div className='my-4'>
                <div className='flex flex-col sm:flex-row items-center justify-between w-full'>
                    <input className='p-3 flex w-full rounded-md text-balck' type='email' placeholder='Enter Email'/>
